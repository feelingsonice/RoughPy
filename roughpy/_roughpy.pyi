...
class TickStreamConstructionHelper:
    ...
    def add_increment(self, label: str, timestamp: Any = ..., data: Any = ...) -> None: ...

    def add_value(self, label: str, timestamp: Any = ..., data: Any = ...) -> None: ...

    def add_categorical(self, label: str, timestamp: Any = ..., variant: Any = ...) -> None: ...

    def add_time_channel(self) -> None: ...
